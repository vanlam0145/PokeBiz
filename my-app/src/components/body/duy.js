...
export const Duy = props => {
  ...
  <div className="page-content">
    <div>
      ...
      <script src="%PUBLIC_URL%/template/js/core/jquery.3.2.1.min.js"></script>
    <script src="%PUBLIC_URL%/template/js/core/popper.min.js"></script>
    <script src="%PUBLIC_URL%/template/js/core/bootstrap.min.js"></script>
    <script src="%PUBLIC_URL%/template/js/now-ui-kit.js?v=1.1.0"></script>
    <script src="%PUBLIC_URL%/template/js/aos.js"></script>
    <script src="%PUBLIC_URL%/template/scripts/main.js"></script>
    </div></div>
